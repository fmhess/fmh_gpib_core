...
# Sat Dec 16 20:02:45 EST 2017
# DO NOT MODIFY


# 
# fmh_gpib_core "fmh_gpib_core" v1.0
# Frank Mori Hess 2017.12.16.20:02:45
...
set_module_assignment embeddedsw.dts.params.reg-shift 1
...
set_interface_property gpib_control_status addressUnits SYMBOLS
...
set_interface_property dma_fifos addressUnits SYMBOLS
...
add_interface_port dma_fifos dma_fifos_address address Input 1
...
add_interface_port dma_fifos dma_fifos_data_out readdata Output 8
add_interface_port dma_fifos dma_fifos_data_in writedata Input 8
...
# 
# connection point transfer_counter
# 
add_interface transfer_counter avalon end
set_interface_property transfer_counter addressUnits WORDS
set_interface_property transfer_counter associatedClock clock
set_interface_property transfer_counter associatedReset reset
set_interface_property transfer_counter bitsPerSymbol 8
set_interface_property transfer_counter burstOnBurstBoundariesOnly false
set_interface_property transfer_counter burstcountUnits WORDS
set_interface_property transfer_counter explicitAddressSpan 0
set_interface_property transfer_counter holdTime 0
set_interface_property transfer_counter linewrapBursts false
set_interface_property transfer_counter maximumPendingReadTransactions 0
set_interface_property transfer_counter maximumPendingWriteTransactions 0
set_interface_property transfer_counter readLatency 0
set_interface_property transfer_counter readWaitStates 0
set_interface_property transfer_counter readWaitTime 0
set_interface_property transfer_counter setupTime 0
set_interface_property transfer_counter timingUnits Cycles
set_interface_property transfer_counter writeWaitTime 0
set_interface_property transfer_counter ENABLED true
set_interface_property transfer_counter EXPORT_OF ""
set_interface_property transfer_counter PORT_NAME_MAP ""
set_interface_property transfer_counter CMSIS_SVD_VARIABLES ""
set_interface_property transfer_counter SVD_ADDRESS_GROUP ""

add_interface_port transfer_counter dma_count_data_out readdata Output 16
add_interface_port transfer_counter dma_count_data_in writedata Input 16
add_interface_port transfer_counter dma_count_read read Input 1
add_interface_port transfer_counter dma_count_write write Input 1
add_interface_port transfer_counter dma_count_chip_select chipselect Input 1
set_interface_assignment transfer_counter embeddedsw.configuration.isFlash 0
set_interface_assignment transfer_counter embeddedsw.configuration.isMemoryDevice 0
set_interface_assignment transfer_counter embeddedsw.configuration.isNonVolatileStorage 0
set_interface_assignment transfer_counter embeddedsw.configuration.isPrintableDevice 0
